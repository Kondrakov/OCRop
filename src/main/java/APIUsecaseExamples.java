...
public class APIUsecaseExamples {
    ...
    //working example pdf --> page bmp --> string csv --> string to recognize (List<List<int[]>>) --> String recognized:
    ...
    public void exampleBitmapLoadingAndAssembling() {
        ...
        //deprecated logic for recognize:
